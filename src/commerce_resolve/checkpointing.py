...
ALLOWED_DOMAIN_TYPES = (
    ...
    ("commerce_resolve.service_resolution", "ServiceVerifiedFact"),
    ("commerce_resolve.service_resolution", "ServiceProgressStep"),
    ("commerce_resolve.service_resolution", "ServiceResolution"),
