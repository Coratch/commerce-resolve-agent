"""验证 v0.8 统一 Eval Catalog 和旧 Suite Adapter。"""
...
def test_catalog_preserves_all_v01_to_v07_scenarios() -> None:
    """验证七个既有 Suite 的 177 个场景无丢失且全局唯一。"""
    ...
    assert {key: value for key, value in counts.items() if key != "v0.8"} == {
        "v0.1": 15,
        "v0.2": 20,
        "v0.3": 20,
        "v0.4": 24,
